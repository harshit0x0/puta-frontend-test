    ...
    <footer className="bg-gray-200 text-gray-700 py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/register">Join PUTA</Link>
              </li>
            </ul>
          </div>
          <div>
            ...
            <p>Email: drmall722000@gmail.com</p>
        ...
        <div className="mt-8 text-center">
          <p>
            &copy; {new Date().getFullYear()} Pantnagar Union of Teachers
            Association (PUTA). All rights reserved.
          </p>
        </div>
      </div>
    </footer>
